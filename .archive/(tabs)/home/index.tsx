...
const CATEGORY_MAP: FortuneTellingCategory[] = [
  "family_friends",
  "money",
  "love",
  "career",
...
export default function HomeScreen() {
  ...
  const videoSource = isFortuneMode
    ? BACKGROUND_VIDEOS.drawing_fortune
    : backgroundVideo;
    ...
    (index: number) => {
      ...
      fetchRandomFortuneTelling(category).then((result) => {
        if (result) {
          ...
          const randomPoem =
            categoryPoems[Math.floor(Math.random() * categoryPoems.length)];
  ...
  return (
    <View style={styles.root}>
      ...
      <Animated.View
        style={[styles.blackFade, { opacity: blackFadeOpacity }]}
        pointerEvents="none"
      />
      ...
      >
        ...
        <View style={[styles.header, { backgroundColor: colors.primary }]}>
          ...
          <Pressable
            onPress={() => router.push("/(modal)/personal-information")}
        ...
        <View style={styles.drawingWrapper}>
          ...
          <Animated.View style={{ opacity: mainButtonOpacity }}>
            ...
            >
              <Text style={[styles.drawingText, { color: colors.onPrimary }]}>
                Drawing
              </Text>
            </Pressable>
          </Animated.View>
      ...
      {/* ── White flash overlay ────────────────────────────── */}
      <Animated.View
        style={[styles.whiteFlash, { opacity: whiteFlashOpacity }]}
        pointerEvents="none"
      />
