...
const gaNavigator = (() => {
  ...
  if (os === "ios") {
    ...
    userAgent =
      typeof navigator !== "undefined" ? navigator.userAgent : userAgent;
  }
...
export function isGameAnalyticsReady(): boolean {
  ...
  return state.isInitialized() && state.isEnabled() && state.sessionIsStarted();
}
...
namespace gameanalytics {
  ...
  export module utilities {
    ...
    export class GAUtilities {
      ...
      public static stringArrayContainsString(
        array: Array<string>,
        search: string,
      ): boolean {
        if (array.length === 0) {
      ...
      private static readonly keyStr: string =
  ...
  export module validators {
    ...
    export class GAValidator {
      public static validateBusinessEvent(
        currency: string,
        amount: number,
        cartType: string,
        itemType: string,
      ...
      public static validateResourceEvent(
      ...
      public static validateProgressionEvent(
      ...
      public static validateErrorEvent(
      ...
      public static validateSdkErrorEvent(
        gameKey: string,
        gameSecret: string,
        category: EGASdkErrorCategory,
        area: EGASdkErrorArea,
      ...
      public static validateEventPartLength(
        eventPart: string,
        allowNull: boolean,
      ): boolean {
      ...
      public static validateEventIdLength(eventId: string): boolean {
        ...
        if (
          !GAUtilities.stringMatch(eventId, /^[^:]{1,64}(?::[^:]{1,64}){0,4}$/)
        ) {
          return false;
        }
        return true;
      ...
      public static validateAndCleanInitRequestResponse(
        initResponse: { [key: string]: any },
      ...
      public static validateShortString(
        shortString: string,
        canBeEmpty: boolean,
      ): boolean {
      ...
      public static validateLongString(
        longString: string,
        canBeEmpty: boolean,
      ): boolean {
      ...
      public static validateCustomDimensions(
      ...
      public static validateResourceCurrencies(
        resourceCurrencies: Array<string>,
      ): boolean {
        if (
      ...
      public static validateResourceItemTypes(
        resourceItemTypes: Array<string>,
      ): boolean {
        if (
          !GAValidator.validateArrayOfStrings(
            20,
      ...
      public static validateDimension01(
        dimension01: string,
      ...
      public static validateDimension02(
        dimension02: string,
        availableDimensions: Array<string>,
      ): boolean {
        // allow nil
      ...
      public static validateDimension03(
        dimension03: string,
        availableDimensions: Array<string>,
      ): boolean {
        // allow nil
      ...
      public static validateArrayOfStrings(
        maxCount: number,
        ...
        for (let i = 0; i < arrayOfStrings.length; ++i) {
          var stringLength: number = !arrayOfStrings[i]
            ? 0
  ...
  export module device {
    ...
    export class GADevice {
      ...
      public static readonly buildPlatform: string =
        GADevice.runtimePlatformToString();
      public static readonly deviceModel: string = GADevice.getDeviceModel();
      public static readonly deviceManufacturer: string =
        GADevice.getDeviceManufacturer();
      public static readonly osVersion: string = GADevice.getOSVersionString();
      public static readonly browserVersion: string =
        GADevice.getBrowserVersionString();
      ...
      private static getBrowserVersionString(): string {
        ...
        var MString: string[] = M[2]
          ? [M[1], M[2]]
          : [gaNavigator.appName, gaNavigator.appVersion, "-?"];
  ...
  export module store {
    ...
    export class GAStore {
      ...
      private static readonly StringFormat = (str: string, ...args: string[]) =>
        str.replace(/{(\d+)}/g, (_, index: number) => args[index] || "");
      ...
      public static select(
        ...
        var currentStore: Array<{ [key: string]: any }> =
          GAStore.getStore(store);
      ...
      public static setItem(gameKey: string, key: string, value: string): void {
        var keyWithPrefix: string = GAStore.StringFormat(
          GAStore.KeyFormat,
          gameKey,
          key,
        );
  ...
  export module state {
    ...
    export class GAState {
      ...
      private remoteConfigsListeners: Array<{
      ...
      public static readonly LastUsedIdentifierKey: string =
      ...
      public static getClientTsAdjusted(): number {
        ...
        var clientTsAdjustedInteger: number =
      ...
      public static ensurePersistedStates(): void {
        ...
        var sdkConfigCachedString: string =
        ...
        if (sdkConfigCachedString) {
          ...
          if (sdkConfigCached) {
            var lastUsedIdentifier: string = GAStore.getItem(
              GAState.getGameKey(),
              GAState.LastUsedIdentifierKey,
            );
            GALogger.d(
        ...
        var results_ga_progression: Array<{ [key: string]: any }> =
          GAStore.select(EGAStore.Progression);

        if (results_ga_progression) {
          for (let i = 0; i < results_ga_progression.length; ++i) {
            var result: { [key: string]: any } = results_ga_progression[i];
            if (result) {
              instance.progressionTries[result["progression"] as string] =
                result["tries"] as number;
            }
          }
        }
      }
      ...
      public static validateAndCleanCustomFields(
        fields: { [id: string]: any },
        errorCallback: (baseMessage: string, message: string) => void = null,
      ): { [id: string]: any } {
        ...
        if (fields) {
          ...
          for (var key in fields) {
            ...
            if (!key || value === null || value === undefined) {
              ...
              var message: string = GAState.formatString(baseMessage, [
                key,
                value,
              ]);
              GALogger.w(message);
      ...
      public static getConfigurationStringValue(
        key: string,
        defaultValue: string,
      ): string {
      ...
      public static addRemoteConfigsListener(listener: {
        onRemoteConfigsUpdated: () => void;
      }): void {
      ...
      public static removeRemoteConfigsListener(listener: {
        onRemoteConfigsUpdated: () => void;
      }): void {
      ...
      public static populateConfigurations(sdkConfig: {
        [key: string]: any;
      }): void {
        ...
        if (configurations) {
          ...
          for (let i = 0; i < configurations.length; ++i) {
            ...
            if (configuration) {
              ...
              var start_ts: number = configuration["start_ts"]
                ? configuration["start_ts"]
                : Number.MIN_VALUE;
              var end_ts: number = configuration["end_ts"]
              ...
              if (
                ...
                GALogger.d(
                  "configuration added: " + JSON.stringify(configuration),
                );
              }
            }
          }
        ...
        var listeners: Array<{ onRemoteConfigsUpdated: () => void }> =
          GAState.instance.remoteConfigsListeners;
      ...
      public static addOnBeforeUnloadListener(listener: {
        onBeforeUnload: () => void;
      }): void {
      ...
      public static removeOnBeforeUnloadListener(listener: {
        onBeforeUnload: () => void;
      }): void {
      ...
      public static notifyBeforeUnloadListeners(): void {
        var listeners: Array<{ onBeforeUnload: () => void }> =
          GAState.instance.beforeUnloadListeners;
  ...
  export module tasks {
    ...
    export class SdkErrorTask {
      ...
      public static execute(
        ...
        var diff: number =
          now.getTime() - SdkErrorTask.timestampMap[type].getTime();
  ...
  export module http {
    ...
    export class GAHTTPApi {
      ...
      public requestInit(
        ...
        var payloadData: string = this.createPayloadData(
          JSONstring,
          this.useGzip,
        );
      ...
      public sendEventsInArray(
        eventArray: Array<{ [key: string]: any }>,
        requestId: string,
        callback: (
          response: EGAHTTPApiResponse,
          json: { [key: string]: any },
        ...
        // Generate URL
        var url: string =
          this.baseUrl + "/" + gameKey + "/" + this.eventsUrlPath;
        ...
        if (!JSONstring) {
          ...
          callback(
            EGAHTTPApiResponse.JsonEncodeFailed,
            null,
            requestId,
            eventArray.length,
          );
      ...
      public sendSdkErrorEvent(
        ...
        var json: { [key: string]: any } =
          GAState.getSdkErrorEventAnnotations();
        ...
        var parameterString: string =
          GAHTTPApi.sdkErrorParameterString(parameter);
      ...
      private static sendEventInArrayRequestCallback(
        ...
        var requestResponseEnum: EGAHTTPApiResponse =
          GAHTTPApi.instance.processRequestResponse(
            responseCode,
            request.statusText,
            body,
            "Events",
        ...
        // if not 200 result
        if (
          requestResponseEnum != EGAHTTPApiResponse.Ok &&
          requestResponseEnum != EGAHTTPApiResponse.Created &&
          requestResponseEnum != EGAHTTPApiResponse.BadRequest
        ) {
          GALogger.d(
        ...
        // decode JSON
        var requestJsonDict: { [key: string]: any } = body
          ? JSON.parse(body)
          : {};

        if (requestJsonDict == null) {
          callback(
            EGAHTTPApiResponse.JsonDecodeFailed,
            null,
            requestId,
            eventCount,
          );
        ...
        if (requestResponseEnum == EGAHTTPApiResponse.BadRequest) {
          GALogger.d(
            "Failed Events Call. Bad request. Response: " +
              JSON.stringify(requestJsonDict),
          );
        }
      ...
      private static initRequestCallback(
        ...
        GALogger.d(
          "init request content : " + body + ", JSONstring: " + JSONstring,
        );
        ...
        if (requestResponseEnum === EGAHTTPApiResponse.BadRequest) {
          GALogger.d(
            "Failed Init Call. Bad request. Response: " +
              JSON.stringify(requestJsonDict),
          );
        ...
        var validatedInitValues: { [key: string]: any } =
    ...
    export class GAEvents {
      ...
      public static addSessionStartEvent(): void {
        ...
        var fieldsToUse: { [id: string]: any } =
          GAState.instance.currentGlobalCustomEventFields;
      ...
      public static addBusinessEvent(
        currency: string,
        amount: number,
        itemType: string,
        itemId: string,
        ...
        var validationResult: ValidationResult =
          GAValidator.validateBusinessEvent(
            currency,
            amount,
            cartType,
            itemType,
      ...
      public static addResourceEvent(
        flowType: EGAResourceFlowType,
        currency: string,
        amount: number,
        itemType: string,
        ...
        // Validate event params
        var validationResult: ValidationResult =
          GAValidator.validateResourceEvent(
            flowType,
            currency,
            amount,
            itemType,
        ...
        var flowTypeString: string =
          GAEvents.resourceFlowTypeToString(flowType);
        eventDict["event_id"] =
      ...
      public static addProgressionEvent(
        progressionStatus: EGAProgressionStatus,
        progression01: string,
        progression02: string,
        progression03: string,
        ...
        var progressionStatusString: string =
          GAEvents.progressionStatusToString(progressionStatus);

        // Validate event params
        var validationResult: ValidationResult =
          GAValidator.validateProgressionEvent(
            progressionStatus,
            progression01,
            progression02,
            progression03,
      ...
      public static addDesignEvent(
        ...
        // Validate
        var validationResult: ValidationResult =
          GAValidator.validateDesignEvent(eventId);
        if (validationResult != null) {
          GAHTTPApi.instance.sendSdkErrorEvent(
            validationResult.category,
            validationResult.area,
      ...
      public static addErrorEvent(
        ...
        fields: { [id: string]: any },
        mergeFields: boolean,
        skipAddingFields: boolean = false,
      ): void {
        if (!GAState.isEventSubmissionEnabled()) {
          return;
        }
        ...
        // Validate
        var validationResult: ValidationResult = GAValidator.validateErrorEvent(
          severity,
          message,
        );
        if (validationResult != null) {
      ...
      public static addAdEvent(
        ...
        // Validate
        var validationResult: ValidationResult = GAValidator.validateAdEvent(
          adAction,
          adType,
          adSdkName,
          adPlacement,
        ...
        if (
          sendDuration &&
          (adType == EGAAdType.RewardedVideo || adType == EGAAdType.Video)
        ) {
        ...
        GALogger.i(
          "Add AD event: {ad_sdk_name:" +
            ...
            ", ad_action:" +
            adActionString +
            (adAction == EGAAdAction.FailedShow && noAdReasonString.length > 0
      ...
      public static processEvents(
        ...
        try {
          ...
          var events: Array<{ [key: string]: any }> = GAStore.select(
            EGAStore.Events,
            selectArgs,
          );
          ...
          GAHTTPApi.instance.sendSdkErrorEvent(
            EGASdkErrorCategory.Json,
            EGASdkErrorArea.ProcessEvents,
            EGASdkErrorAction.JsonError,
            EGASdkErrorParameter.Undefined,
            e.stack,
            GAState.getGameKey(),
            GAState.getGameSecret(),
      ...
      private static processEventsCallback(
        responseEnum: EGAHTTPApiResponse,
      ...
      private static fixMissingSessionEndEvents(): void {
        ...
        var sessions: Array<{ [key: string]: any }> = GAStore.select(
          EGAStore.Sessions,
          args,
        );
        ...
        for (let i = 0; i < sessions.length; ++i) {
          var sessionEndEvent: { [key: string]: any } = JSON.parse(
            GAUtilities.decode64(sessions[i]["event"] as string),
          );
      ...
      private static addEventToStore(eventData: { [key: string]: any }): void {
        ...
        try {
          ...
          if (
            ...
            GAHTTPApi.instance.sendSdkErrorEvent(
              EGASdkErrorCategory.Database,
              EGASdkErrorArea.AddEventsToStore,
              EGASdkErrorAction.DatabaseTooLarge,
              EGASdkErrorParameter.Undefined,
              "",
              GAState.getGameKey(),
              GAState.getGameSecret(),
      ...
      private static resourceFlowTypeToString(value: any): string {
        if (
          value == EGAResourceFlowType.Source ||
          value == EGAResourceFlowType[EGAResourceFlowType.Source]
        ) {
          return "Source";
        } else if (
          value == EGAResourceFlowType.Sink ||
          value == EGAResourceFlowType[EGAResourceFlowType.Sink]
        ) {
          return "Sink";
        } else {
          return "";
      ...
      private static progressionStatusToString(value: any): string {
        if (
          value == EGAProgressionStatus.Start ||
          value == EGAProgressionStatus[EGAProgressionStatus.Start]
        ) {
          return "Start";
        } else if (
          value == EGAProgressionStatus.Complete ||
          value == EGAProgressionStatus[EGAProgressionStatus.Complete]
        ) {
          return "Complete";
        } else if (
          value == EGAProgressionStatus.Fail ||
          value == EGAProgressionStatus[EGAProgressionStatus.Fail]
        ) {
          return "Fail";
        } else {
          return "";
      ...
      private static errorSeverityToString(value: any): string {
        if (
          value == EGAErrorSeverity.Debug ||
          value == EGAErrorSeverity[EGAErrorSeverity.Debug]
        ) {
          return "debug";
        } else if (
          value == EGAErrorSeverity.Info ||
          value == EGAErrorSeverity[EGAErrorSeverity.Info]
        ) {
          return "info";
        } else if (
          value == EGAErrorSeverity.Warning ||
          value == EGAErrorSeverity[EGAErrorSeverity.Warning]
        ) {
          return "warning";
        } else if (
          value == EGAErrorSeverity.Error ||
          value == EGAErrorSeverity[EGAErrorSeverity.Error]
        ) {
          return "error";
        } else if (
          value == EGAErrorSeverity.Critical ||
          value == EGAErrorSeverity[EGAErrorSeverity.Critical]
        ) {
          return "critical";
        } else {
          return "";
      ...
      private static adActionToString(value: any): string {
        if (
          value == EGAAdAction.Clicked ||
          value == EGAAdAction[EGAAdAction.Clicked]
        ) {
          return "clicked";
        } else if (
          value == EGAAdAction.Show ||
          value == EGAAdAction[EGAAdAction.Show]
        ) {
          return "show";
        } else if (
          value == EGAAdAction.FailedShow ||
          value == EGAAdAction[EGAAdAction.FailedShow]
        ) {
          return "failed_show";
        } else if (
          value == EGAAdAction.RewardReceived ||
          value == EGAAdAction[EGAAdAction.RewardReceived]
        ) {
      ...
      private static adErrorToString(value: any): string {
        if (
          value == EGAAdError.Unknown ||
          value == EGAAdError[EGAAdError.Unknown]
        ) {
          return "unknown";
        } else if (
          value == EGAAdError.Offline ||
          value == EGAAdError[EGAAdError.Offline]
        ) {
          return "offline";
        } else if (
          value == EGAAdError.NoFill ||
          value == EGAAdError[EGAAdError.NoFill]
        ) {
          return "no_fill";
        } else if (
          value == EGAAdError.InternalError ||
          value == EGAAdError[EGAAdError.InternalError]
        ) {
          return "internal_error";
        } else if (
          value == EGAAdError.InvalidRequest ||
          value == EGAAdError[EGAAdError.InvalidRequest]
        ) {
          return "invalid_request";
        } else if (
          value == EGAAdError.UnableToPrecache ||
          value == EGAAdError[EGAAdError.UnableToPrecache]
        ) {
      ...
      private static adTypeToString(value: any): string {
        if (value == EGAAdType.Video || value == EGAAdType[EGAAdType.Video]) {
          ...
          value == EGAAdType.RewardedVideo ||
          value == EGAAdError[EGAAdType.RewardedVideo]
        ) {
          return "rewarded_video";
        } else if (
          value == EGAAdType.Playable ||
          value == EGAAdError[EGAAdType.Playable]
        ) {
          return "playable";
        } else if (
          value == EGAAdType.Interstitial ||
          value == EGAAdError[EGAAdType.Interstitial]
        ) {
          return "interstitial";
        } else if (
          value == EGAAdType.OfferWall ||
          value == EGAAdError[EGAAdType.OfferWall]
        ) {
          return "offer_wall";
        } else if (
          value == EGAAdType.Banner ||
          value == EGAAdError[EGAAdType.Banner]
        ) {
          return "banner";
        } else {
          return "";
  ...
  export module threading {
    ...
    export class PriorityQueue<TItem> {
      ...
      private addQueueOfPriority(priority: number): void {
        ...
        this._sortedKeys.sort((x: number, y: number) =>
    ...
    export class GAThreading {
      ...
      public readonly blocks: PriorityQueue<TimedBlock> =
        new PriorityQueue<TimedBlock>(<IComparer<number>>{
      ...
      public static performTaskOnGAThread(
        taskBlock: () => void,
      ...
      private static getNextBlock(): TimedBlock {
        ...
        if (
          ...
          GAThreading.instance.blocks.peek().deadline.getTime() <= now.getTime()
        ) {
  ...
  export class GameAnalytics {
    ...
    public static configureAvailableCustomDimensions01(
      customDimensions: Array<string> = [],
    ): void {
    ...
    public static configureAvailableCustomDimensions02(
      customDimensions: Array<string> = [],
    ): void {
      GAThreading.performTaskOnGAThread(() => {
        if (GameAnalytics.isSdkReady(true, false)) {
    ...
    public static configureAvailableCustomDimensions03(
      customDimensions: Array<string> = [],
    ): void {
      GAThreading.performTaskOnGAThread(() => {
        if (GameAnalytics.isSdkReady(true, false)) {
    ...
    public static configureAvailableResourceCurrencies(
      resourceCurrencies: Array<string> = [],
    ): void {
      GAThreading.performTaskOnGAThread(() => {
        if (GameAnalytics.isSdkReady(true, false)) {
    ...
    public static configureAvailableResourceItemTypes(
      resourceItemTypes: Array<string> = [],
    ): void {
      GAThreading.performTaskOnGAThread(() => {
        if (GameAnalytics.isSdkReady(true, false)) {
    ...
    public static configureSdkGameEngineVersion(
    ...
    public static configureGameEngineVersion(
    ...
    public static addBusinessEvent(
      ...
      if (!GAState.instance.isUnloading) {
        ...
        if (
          !GameAnalytics.isSdkReady(true, true, "Could not add business event")
        ) {
          return;
        }
        // Send to events
    ...
    public static addResourceEvent(
      flowType: EGAResourceFlowType = EGAResourceFlowType.Undefined,
      currency: string = "",
      amount: number = 0,
      itemType: string = "",
      itemId: string = "",
      ...
      if (!GAState.instance.isUnloading) {
        ...
        if (
          !GameAnalytics.isSdkReady(true, true, "Could not add resource event")
        ) {
          return;
        }
    ...
    public static addProgressionEvent(
      progressionStatus: EGAProgressionStatus = EGAProgressionStatus.Undefined,
      progression01: string = "",
      progression02: string = "",
      progression03: string = "",
      score?: number,
    ...
    public static addErrorEvent(
      severity: EGAErrorSeverity = EGAErrorSeverity.Undefined,
      message: string = "",
      customFields: { [id: string]: any } = {},
      mergeFields: boolean = false,
    ): void {
    ...
    public static addAdEventWithNoAdReason(
      adAction: EGAAdAction = EGAAdAction.Undefined,
      adType: EGAAdType = EGAAdType.Undefined,
      adSdkName: string = "",
      adPlacement: string = "",
      noAdReason: EGAAdError = EGAAdError.Undefined,
      customFields: { [id: string]: any } = {},
      mergeFields: boolean = false,
    ): void {
      GADevice.updateConnectionType();
    ...
    public static addAdEventWithDuration(
      adAction: EGAAdAction = EGAAdAction.Undefined,
      adType: EGAAdType = EGAAdType.Undefined,
      adSdkName: string = "",
      adPlacement: string = "",
    ...
    public static setGlobalCustomEventFields(
      customFields: { [id: string]: any } = {},
    ): void {
      GAThreading.performTaskOnGAThread(() => {
        GALogger.i(
    ...
    public static getRemoteConfigsValueAsString(
      key: string,
    ...
    private static startNewSessionCallback(
      initResponse: EGAHTTPApiResponse,
      initResponseDict: { [key: string]: any },
    ): void {
      // init is ok
      if (
      ...
      GAState.instance.clientServerTimeOffset = GAState.getSdkConfig()[
        ...
        ? (GAState.getSdkConfig()["time_offset"] as number)
        : 0;
      ...
      var timedBlock: TimedBlock = GAThreading.getTimedBlockById(
